      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-sm flex flex-col max-h-[90vh]">
        ...
        <div className="overflow-y-auto flex-1 p-4">
          ...
          >
            ...
            {/* Invoice info — labels bilingual (English / Dari) so the shared receipt is understood regardless of UI language */}
            <div className="row" style={{ display: 'flex', justifyContent: 'space-between', margin: '3px 0' }}>
              <span>Invoice / فاکتور #:</span>
            ...
            <table className="items-table" style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
                <tr>
                  <th style={{ textAlign: 'start', borderBottom: '1px solid #000', padding: '2px 0', fontSize: '10px' }}>Item / محصول</th>
                  <th style={{ textAlign: 'center', borderBottom: '1px solid #000', padding: '2px 0', fontSize: '10px', width: '32px' }}>Qty / تعداد</th>
                  <th style={{ textAlign: 'end', borderBottom: '1px solid #000', padding: '2px 0', fontSize: '10px', width: '55px' }}>Price / قیمت</th>
                  <th style={{ textAlign: 'end', borderBottom: '1px solid #000', padding: '2px 0', fontSize: '10px', width: '60px' }}>Total / مجموع</th>
                </tr>
              </thead>
              <tbody>
