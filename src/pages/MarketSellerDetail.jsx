...
export default function MarketSellerDetail() {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Anas Hadi's earnings on this seller */}
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5">
        <div className="text-xs font-semibold text-slate-600 uppercase tracking-wide mb-3">💰 Anas Hadi Earnings</div>
        <div className="grid grid-cols-3 gap-3">
          <div>
      ...
      <Modal open={txModal} onClose={() => setTxModal(false)} title={editTxItem ? t('market.editTransaction') : t('market.addTransaction')}>
        <form onSubmit={handleTxSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-xs font-medium text-slate-600 mb-1">💰 Commission per chicken (AFN) — Anas Hadi's earnings</label>
